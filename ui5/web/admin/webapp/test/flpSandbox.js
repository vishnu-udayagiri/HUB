		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#ivloptihubadmindashboard-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ivloptihubadmindashboard-display": {
								"semanticObject": "ivloptihubadmindashboard",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ivl.optihub.admindashboard",
									"url": sap.ui.require.toUrl("ivl/optihub/admindashboard")
								}
							}
						}
					}
