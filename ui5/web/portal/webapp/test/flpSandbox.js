		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "OptiHub Ui5",
									"targetURL": "#comivloptihubui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comivloptihubui5-display": {
								"semanticObject": "comivloptihubui5",
								"action": "display",
								"description": "Ui application of optihub",
								"title": "OptiHub Ui5",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ivl.optihub.ui5",
									"url": sap.ui.require.toUrl("com/ivl/optihub/ui5")
								}
							}
						}
					}
